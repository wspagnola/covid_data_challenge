...
recode_measures <- c('18 - 24' = 'age18_24' , 
                     '25 - 39' = 'age25_39')


#For States

#Same as name_vec1 but doesn't have martial non-response item 
name_vec1a <- c('Total', 'age18_24', 'age25_39', 'age40_54', 'age55_64', 'age_over65',
               'sex_male', 'sex_female', 
               'race_latino', 'race_white', 'race_black', 'race_asian', 'race_multi',
               'ed_less_than_hs', 'ed_hs', 'ed_some_college','ed_college',
               'marital_married', 'marital_widow', 'marital_divorce', 
               'marital_never',
               'child_yes', 'child_no', 
